...
public class Emp implements Serializable {
	...
	public Emp(String tbEmpName, String tbEmpSex, Integer tbEmpAge, String tbEmpAddress,
			String tbEmpImg, Date tbEmpBirthday,
			Integer tbEmpDid) {
		super();
		this.tbEmpName = tbEmpName;
		this.tbEmpSex = tbEmpSex;
		this.tbEmpAge = tbEmpAge;
		this.tbEmpAddress = tbEmpAddress;
		this.tbEmpImg = tbEmpImg;
		this.tbEmpBirthday = tbEmpBirthday;
		this.tbEmpDid = tbEmpDid;
	}
