...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						<input type="hidden" name="contentid" id="hiddem_txt_contentid" value=""/>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hiddem_txt_contentid").value='';
	...
	function initEditUser(getSelection){
		$('#hiddem_txt_contentid').val(getSelection.contentid);
	...
	$("#del_user_btn").click(function(){
		...
		getSelections.forEach(function(item){
			idArr.push(item.contentcategoryid);
		});
		ids = idArr.join(",");
		$.ajax({
		    url:"deleteUser.htm",
