...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="radio" name="tbEmpSex" class="" id="txt_search_tbEmpSex2" value="2">女
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">员工年龄</span>
			      <input type="text" name="age1" class="" id="txt_search_tbEmpAge1">-
			      <input type="text" name="age2" class="" id="txt_search_tbEmpAge2">
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">员工生日</span>
			      <input type="date" name="birthday1" class="" id="txt_search_tbEmpBirthday1">-
			      <input type="date" name="birthday2" class="" id="txt_search_tbEmpBirthday2">
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">员工部门</span>
					<select class="form-control" name="tbEmpDid" id = "txt_search_tbEmpDid">
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>员工头像：</td>
								<td colspan="4">
				<img alt="" src="" id="pic" width="30px" height="30px">
	...
	<div class="modal fade" id="modal_user_inload" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-body">
				<form action="inload.htm" enctype="multipart/form-data" id="forminload">
						<input type="file" name="inloadfile">
				</form>
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="inloadjs">导入</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_inload").click(function(){
	    			$('#modal_user_inload').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_user_inload").show();
	        });
	...
	function initEditUser(getSelection){
		...
		$('#tbEmpBirthday').val(new Date(getSelection.tbEmpAge).Format('yyyy-MM-dd'));
		$('#tbEmpDid').val(getSelection.tbEmpDid);
		$('#pics').val(getSelection.tbEmpImg);//如果不修改图片  将原有的图片赋值
		$('#pic').attr('src',"/img/"+getSelection.tbEmpImg);
		alert(getSelection.tbEmpImg)
	}
